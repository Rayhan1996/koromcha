                ...
                <div class="container clearfix">
                    ...
                    <div class="extra-nav">
						...
						if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
							?>
							<a href="profile.php?userId=<?php echo $_SESSION["userId"] ?>" class="site-button"><i class="fa fa-user"></i> <?php echo $_SESSION["firstname"] ?></a>
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                        <ul class="nav navbar-nav">
							<li class="active">
								...
								<ul class="sub-menu">
									<li><a href="index-2.php" class="dez-page">Home 1</a></li>
									<li><a href="index-3.php" class="dez-page">Home 2</a></li>
								</ul>
							</li>
							<li>
								<a href="#">For Candidates <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									<li><a href="all-jobs.php" class="dez-page">Browse Job</a></li>
