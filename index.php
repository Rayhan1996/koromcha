...
<!-- Content -->
            ...
            <div class="container">
                <div class="dez-bnr-inr-entry align-m ">
					<div class="find-job-bx">
						...
						<form class="dezPlaceAni" method="GET" action="search.php">
							<div class="row">
								...
								<div class="col-lg-2 col-md-6">
									<button type="submit" class="site-button btn-block">Find Job<a href="/search.php"></a></button>
								</div>
							</div>
						</form>
					</div>
		...
		<!-- Section Banner END -->
        <!-- About Us -->
		<div class="section-full job-categories content-inner-2 bg-white" style="background-image:url(../images/pattern/pic1.php);">
			<div class="container">
